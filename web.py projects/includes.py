...
from redisSessions import redisSessions
...
# Declare your database shit. Also, make up your bloody mind. Stop switchiing from MySQL to CouchDB to Neo4j for no good reason
